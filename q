...
DDEESSCCRRIIPPTTIIOONN
       ...
       List commits that are reachable by following the ppaarreenntt links from the given commit(s), but exclude commits
       that are reachable from the one(s) given with a _^ in front of them. The output is given in reverse
       chronological order by default.

       You can think of this as a set operation. Commits reachable from any of the commits given on the command line
       form a set, and then commits reachable from any of the ones given with _^ in front are subtracted from that
       set. The remaining commits are what comes out in the command’s output. Various other options and paths
       ...
       means "list all the commits which are reachable from _f_o_o or _b_a_r, but not from _b_a_z".

       A special notation "_<_c_o_m_m_i_t_1_>.._<_c_o_m_m_i_t_2_>" can be used as a short-hand for "^_<_c_o_m_m_i_t_1_> _<_c_o_m_m_i_t_2_>". For
       example, either of the following may be used interchangeably:

           $ git log origin..HEAD
           $ git log HEAD ^origin

       Another special notation is "_<_c_o_m_m_i_t_1_>..._<_c_o_m_m_i_t_2_>" which is useful for merges. The resulting set of commits
       is the symmetric difference between the two operands. The following two commands are equivalent:

           $ git log A B --not $(git merge-base --all A B)
           $ git log A...B

       The command takes options applicable to the ggiitt--rreevv--lliisstt(1) command to control what is shown and how, and
       options applicable to the ggiitt--ddiiffff(1) command to control how the changes each commit introduces are shown.
...
OOPPTTIIOONNSS
       ...
       --no-decorate, --decorate[=short|full|auto|no]
           ...
           ref names are shown as if _s_h_o_r_t were given, otherwise no ref names are shown. The option ----ddeeccoorraattee is
           short-hand for ----ddeeccoorraattee==sshhoorrtt. Default to configuration value of lloogg..ddeeccoorraattee if configured, otherwise,
           aauuttoo.
       ...
       --decorate-refs=<pattern>, --decorate-refs-exclude=<pattern>
           ...
           the patterns given to ----ddeeccoorraattee--rreeffss. The lloogg..eexxcclluuddeeDDeeccoorraattiioonn config option allows excluding refs from
           the decorations, but an explicit ----ddeeccoorraattee--rreeffss pattern will override a match in lloogg..eexxcclluuddeeDDeeccoorraattiioonn.
       ...
       --full-diff
           Without this flag, ggiitt lloogg --pp <<ppaatthh>>......  shows commits that touch the specified paths, and diffs about
       ...
       -L<start>,<end>:<file>, -L:<funcname>:<file>
           Trace the evolution of the line range given by _<_s_t_a_r_t_>_,_<_e_n_d_>, or by the function name regex _<_f_u_n_c_n_a_m_e_>,
           within the _<_f_i_l_e_>. You may not give any pathspec limiters. This is currently limited to a walk starting
           from a single revision, i.e., you may only give zero or one positive revision arguments, and _<_s_t_a_r_t_> and
           _<_e_n_d_> (or _<_f_u_n_c_n_a_m_e_>) must exist in the starting revision. You can specify this option more than once.
           Implies ----ppaattcchh. Patch output can be suppressed using ----nnoo--ppaattcchh, but other diff formats (namely ----rraaww,
           ----nnuummssttaatt, ----sshhoorrttssttaatt, ----ddiirrssttaatt, ----ssuummmmaarryy, ----nnaammee--oonnllyy, ----nnaammee--ssttaattuuss, ----cchheecckk) are not currently
           implemented.
           ...
           •   number
               ...
               If _<_s_t_a_r_t_> or _<_e_n_d_> is a number, it specifies an absolute line number (lines count from 1).

           •   //rreeggeexx//

               This form will use the first line matching the given POSIX regex. If _<_s_t_a_r_t_> is a regex, it will
               search from the end of the previous --LL range, if any, otherwise from the start of file. If _<_s_t_a_r_t_> is
               ^^//rreeggeexx//, it will search from the start of file. If _<_e_n_d_> is a regex, it will search starting at the
               line given by _<_s_t_a_r_t_>.

           •   +offset or -offset

               This is only valid for _<_e_n_d_> and will specify a number of lines before or after the line given by
               _<_s_t_a_r_t_>.

           If ::<<ffuunnccnnaammee>> is given in place of _<_s_t_a_r_t_> and _<_e_n_d_>, it is a regular expression that denotes the range
           from the first funcname line that matches _<_f_u_n_c_n_a_m_e_>, up to the next funcname line.  ::<<ffuunnccnnaammee>> searches
           from the end of the previous --LL range, if any, otherwise from the start of file.  ^^::<<ffuunnccnnaammee>> searches
           from the start of file. The function names are determined in the same way as ggiitt ddiiffff works out patch
           hunk headers (see _D_e_f_i_n_i_n_g _a _c_u_s_t_o_m _h_u_n_k_-_h_e_a_d_e_r in ggiittaattttrriibbuutteess(5)).
   ...
   CCoommmmiitt LLiimmiittiinngg
       ...
       --author=<pattern>, --committer=<pattern>
           ...
           (regular expression). With more than one ----aauutthhoorr==<<ppaatttteerrnn>>, commits whose author matches any of the
           given patterns are chosen (similarly for multiple ----ccoommmmiitttteerr==<<ppaatttteerrnn>>).
       ...
       --grep=<pattern>
           ...
           expression). With more than one ----ggrreepp==<<ppaatttteerrnn>>, commits whose message matches any of the given patterns
           are chosen (but see ----aallll--mmaattcchh).

           When ----nnootteess is in effect, the message from the notes is matched as if it were part of the log message.
       ...
       --first-parent
           ...
           This option also changes default diff format for merge commits to ffiirrsstt--ppaarreenntt, see
           ----ddiiffff--mmeerrggeess==ffiirrsstt--ppaarreenntt for details.
       ...
       --tags[=<pattern>]
           Pretend as if all the refs in rreeffss//ttaaggss are listed on the command line as _<_c_o_m_m_i_t_>. If _<_p_a_t_t_e_r_n_> is
           given, limit tags to ones matching given shell glob. If pattern lacks _?, _*, or _[, _/_* at the end is
           implied.
       ...
       --alternate-refs
           ...
           oobbjjeeccttss//iinnffoo//aalltteerrnnaatteess. The set of included objects may be modified by ccoorree..aalltteerrnnaatteeRReeffssCCoommmmaanndd, etc.
       ...
       --bisect
           ...
           good bisection refs rreeffss//bbiisseecctt//ggoooodd--** on the command line.
       ...
       -g, --walk-reflogs
           ...
           With ----pprreettttyy format other than oonneelliinnee and rreeffeerreennccee (for obvious reasons), this causes the output to
           have two extra lines of information taken from the reflog. The reflog designator in the output may be
           shown as rreeff@@{{NNtthh}} (where NNtthh is the reverse-chronological index in the reflog) or as rreeff@@{{ttiimmeessttaammpp}}
           ...
           Under ----pprreettttyy==oonneelliinnee, the commit message is prefixed with this information on the same line. This
           option cannot be combined with ----rreevveerrssee. See also ggiitt--rreefflloogg(1).
   ...
   HHiissttoorryy SSiimmpplliiffiiccaattiioonn
       ...
       Default mode
           ...
           it prunes some side branches if the end result is the same (i.e. merging branches with the same content)

       --show-pulls
           Include all commits from the default mode, but also any merge commits that are not TREESAME to the first
           parent but are TREESAME to a later parent. This mode is helpful for showing the merge commits that "first
       ...
       --full-history with parent rewriting
           Ordinary commits are only included if they are !TREESAME (though this can be changed, see ----ssppaarrssee
           below).
           ...
           Compare to ----ffuullll--hhiissttoorryy without rewriting above. Note that EE was pruned away because it is TREESAME,
           but the parent list of P was rewritten to contain EE's parent II. The same happened for CC and NN, and XX, YY
           and QQ.
       ...
       --simplify-merges
           ...
           •   PP's parent list similarly had II removed.  PP was then removed completely, because it had one parent
               and is TREESAME.
       ...
       --ancestry-path
           ...
           in the given commit range. I.e. only display commits that are ancestor of the “to” commit and descendants
           of the “from” commit.
           ...
           ancestors of DD. This is useful to see what happened to the history leading to MM since DD, in the sense
           that “what does MM have that did not exist in DD”. The result in this example would be all the commits,
           except AA and BB (and DD itself, of course).
       ...
       Before discussing another option, ----sshhooww--ppuullllss, we need to create a new example history.
       ...
       options such as ----ffuullll--hhiissttoorryy and ----ssiimmpplliiffyy--mmeerrggeess works in that case:
       ...
       For this example, suppose II created ffiillee..ttxxtt which was modified by AA, BB, and XX in different ways. The
       single-parent commits CC, ZZ, and YY do not change ffiillee..ttxxtt. The merge commit MM was created by resolving the
       merge conflict to include both changes from AA and BB and hence is not TREESAME to either. The merge commit RR,
       however, was created by ignoring the contents of ffiillee..ttxxtt at MM and taking only the contents of ffiillee..ttxxtt at XX.
       Hence, RR is TREESAME to XX but not MM. Finally, the natural merge resolution to create NN is to take the
       contents of ffiillee..ttxxtt at RR, so NN is TREESAME to RR but not CC. The merge commits OO and PP are TREESAME to their
       first parents, but not to their second parents, ZZ and YY respectively.

       When using the default mode, NN and RR both have a TREESAME parent, so those edges are walked and the others
       are ignored. The resulting history graph is:

                   I---X

       When using ----ffuullll--hhiissttoorryy, Git walks every edge. This will discover the commits AA and BB and the merge MM, but
       also will reveal the merge commits OO and PP. With parent rewriting, the resulting graph is:
       ...
       Here, the merge commits OO and PP contribute extra noise, as they did not actually contribute a change to
       ffiillee..ttxxtt. They only merged a topic that was based on an older version of ffiillee..ttxxtt. This is a common issue in
       repositories using a workflow where many contributors work in parallel and merge their topic branches along a
       single trunk: manu unrelated merges appear in the ----ffuullll--hhiissttoorryy results.

       When using the ----ssiimmpplliiffyy--mmeerrggeess option, the commits OO and PP disappear from the results. This is because the
       rewritten second parents of OO and PP are reachable from their first parents. Those edges are removed and then
       the commits look like single-parent commits that are TREESAME to their parent. This also happens to the
       commit NN, resulting in a history view as follows:
       ...
       In this view, we see all of the important single-parent changes from AA, BB, and XX. We also see the
       carefully-resolved merge MM and the not-so-carefully-resolved merge RR. This is usually enough information to
       determine why the commits AA and BB "disappeared" from history in the default view. However, there are a few
       issues with this approach.

       The first issue is performance. Unlike any previous option, the ----ssiimmpplliiffyy--mmeerrggeess option requires walking the
       entire commit history before returning a single result. This can make the option difficult to use for very
       large repositories.

       The second issue is one of auditing. When many contributors are working on the same repository, it is
       important which merge commits introduced a change into an important branch. The problematic merge RR above is
       not likely to be the merge commit that was used to merge into an important branch. Instead, the merge NN was
       used to merge RR and XX into the important branch. This commit may have information about why the change XX came
       to override the changes from AA and BB in its commit message.

       --show-pulls
           In addition to the commits shown in the default history, show each merge commit that is not TREESAME to
           its first parent but is TREESAME to a later parent.

           When a merge commit is included by ----sshhooww--ppuullllss, the merge is treated as if it "pulled" the change from
           another branch. When using ----sshhooww--ppuullllss on this example (and no other options) the resulting graph is:

                       I---X---R---N

           Here, the merge commits RR and NN are included because they pulled the commits XX and RR into the base
           branch, respectively. These merges are the reason the commits AA and BB do not appear in the default
           history.

           When ----sshhooww--ppuullllss is paired with ----ssiimmpplliiffyy--mmeerrggeess, the graph includes all of the necessary information:
           ...
           Notice that since MM is reachable from RR, the edge from NN to MM was simplified away. However, NN still
           appears in the history as an important commit because it "pulled" the change RR into the main branch.

       The ----ssiimmpplliiffyy--bbyy--ddeeccoorraattiioonn option allows you to view only the big picture of the topology of the history,
       ...
       the contents of the paths given on the command line. All other commits are marked as TREESAME (subject to be
       simplified away).
   ...
   CCoommmmiitt FFoorrmmaattttiinngg
       --pretty[=<format>], --format=<format>
           ...
           _s_h_o_r_t, _m_e_d_i_u_m, _f_u_l_l, _f_u_l_l_e_r, _r_e_f_e_r_e_n_c_e, _e_m_a_i_l, _r_a_w, _f_o_r_m_a_t_:_<_s_t_r_i_n_g_> and _t_f_o_r_m_a_t_:_<_s_t_r_i_n_g_>. When _<_f_o_r_m_a_t_>
           is none of the above, and has _%_p_l_a_c_e_h_o_l_d_e_r in it, it acts as if _-_-_p_r_e_t_t_y_=_t_f_o_r_m_a_t_:_<_f_o_r_m_a_t_> were given.
       ...
       --abbrev-commit
           Instead of showing the full 40-byte hexadecimal commit object name, show a prefix that names the object
           uniquely. "--abbrev=<n>" (which also modifies diff output, if it is displayed) option can be used to
           specify the minimum length of the prefix.

           This should make "--pretty=oneline" a whole lot more readable for people using 80-column terminals.

       --no-abbrev-commit
           Show the full 40-byte hexadecimal commit object name. This negates ----aabbbbrreevv--ccoommmmiitt, either explicit or
           implied by other options such as "--oneline". It also overrides the lloogg..aabbbbrreevvCCoommmmiitt variable.
       ...
       --encoding=<encoding>
           ...
           option can be used to tell the command to re-code the commit log message in the encoding preferred by the
           user. For non plumbing commands this defaults to UTF-8. Note that if an object claims to be encoded in XX
           and we are outputting in XX, we will output the object verbatim; this means that invalid sequences in the
           original commit may be copied to the output. Likewise, if iconv(3) fails to convert the commit, we will
       ...
       --notes[=<ref>]
           ...
           With an optional _<_r_e_f_> argument, use the ref to find the notes to display. The ref can specify the full
           refname when it begins with rreeffss//nnootteess//; when it begins with nnootteess//, rreeffss// and otherwise rreeffss//nnootteess// is
       ...
       --show-signature
           Check the validity of a signed commit object by passing the signature to ggppgg ----vveerriiffyy and show the
           output.
       ...
       --date=<format>
           ...
           ----ddaattee==hhuummaann shows the timezone if the timezone does not match the current time-zone, and doesn’t print
           the whole date if that matches (ie skip printing year for dates that are "this year", but also skip the
           whole date itself if it’s in the last few days and we can just say what weekday it was). For older dates
           the hour and minute is also omitted.
...
PPRREETTTTYY FFOORRMMAATTSS
       ...
       inserted before the _A_u_t_h_o_r_: line. This line begins with "Merge: " and the hashes of ancestral commits are
       ...
       •   _r_e_f_e_r_e_n_c_e
           ...
           ----pprreettttyy==''ffoorrmmaatt::%%CC((aauuttoo))%%hh ((%%ss,, %%aadd))''. By default, the date is formatted with ----ddaattee==sshhoorrtt unless
           another ----ddaattee option is explicitly specified. As with any ffoorrmmaatt:: with format placeholders, its output
           is not affected by other options like ----ddeeccoorraattee and ----wwaallkk--rreeffllooggss.
       ...
       •   _m_b_o_x_r_d
           ...
           Like _e_m_a_i_l, but lines in the commit message starting with "From " (preceded by zero or more ">") are
           quoted with ">" so they aren’t confused as starting a new commit.

       •   _r_a_w

           The _r_a_w format shows the entire commit exactly as stored in the commit object. Notably, the hashes are
       ...
       •   _f_o_r_m_a_t_:_<_s_t_r_i_n_g_>
           ...
           The _f_o_r_m_a_t_:_<_s_t_r_i_n_g_> format allows you to specify which information you want to show. It works a little
           bit like printf format, with the notable exception that you get a newline with _%_n instead of _\_n.
           ...
           •   Placeholders that affect formatting of later placeholders:
               ...
               _%_C_(_._._._)
                   color specification, as described under Values in the "CONFIGURATION FILE" section of ggiitt--
                   ccoonnffiigg(1). By default, colors are shown only when enabled for log output (by ccoolloorr..ddiiffff,
                   ccoolloorr..uuii, or ----ccoolloorr, and respecting the aauuttoo settings of the former if we are going to a
                   terminal).  %%CC((aauuttoo,,......))  is accepted as a historical synonym for the default (e.g.,
                   %%CC((aauuttoo,,rreedd))). Specifying %%CC((aallwwaayyss,,......))  will show the colors even when color is not otherwise
                   enabled (though consider just using ----ccoolloorr==aallwwaayyss to enable color for the whole output,
                   including this format and anything else git might color).  aauuttoo alone (i.e.  %%CC((aauuttoo))) will turn
               ...
               _%_<_(_<_N_>_[_,_t_r_u_n_c_|_l_t_r_u_n_c_|_m_t_r_u_n_c_]_)
                   make the next placeholder take at least N columns, padding spaces on the right if necessary.
                   Optionally truncate at the beginning (ltrunc), the middle (mtrunc) or the end (trunc) if the
                   output is longer than N columns. Note that truncating only works correctly with N >= 2.

               _%_<_|_(_<_N_>_)
                   make the next placeholder take at least until Nth columns, padding spaces on the right if
                   necessary

               _%_>_(_<_N_>_), _%_>_|_(_<_N_>_)
                   similar to _%_<_(_<_N_>_), _%_<_|_(_<_N_>_) respectively, but padding spaces on the left

               _%_>_>_(_<_N_>_), _%_>_>_|_(_<_N_>_)
                   similar to _%_>_(_<_N_>_), _%_>_|_(_<_N_>_) respectively, except that if the next placeholder takes more spaces
                   than given and there are spaces on its left, use those spaces

               _%_>_<_(_<_N_>_), _%_>_<_|_(_<_N_>_)
                   similar to _%_<_(_<_N_>_), _%_<_|_(_<_N_>_) respectively, but padding both sides (i.e. the text is centered)
           ...
           •   Placeholders that expand to information extracted from the commit:
               ...
               _%_a_N
                   author name (respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))

               _%_a_e
                   author email

               _%_a_E
                   author email (respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))

               _%_a_l
                   author email local-part (the part before the _@ sign)

               _%_a_L
                   author local-part (see _%_a_l) respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))
               ...
               _%_a_h
                   author date, human style (like the ----ddaattee==hhuummaann option of ggiitt--rreevv--lliisstt(1))

               _%_c_n
                   committer name

               _%_c_N
                   committer name (respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))

               _%_c_e
                   committer email

               _%_c_E
                   committer email (respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))

               _%_c_l
                   committer email local-part (the part before the _@ sign)

               _%_c_L
                   committer local-part (see _%_c_l) respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))
               ...
               _%_c_h
                   committer date, human style (like the ----ddaattee==hhuummaann option of ggiitt--rreevv--lliisstt(1))
               ...
               _%_(_d_e_s_c_r_i_b_e_[_:_o_p_t_i_o_n_s_]_)
                   human-readable name, like ggiitt--ddeessccrriibbee(1); empty string for undescribable commits. The ddeessccrriibbee
                   string may be followed by a colon and zero or more comma-separated options. Descriptions can be
                   inconsistent when tags are added or removed at the same time.

                   •   _m_a_t_c_h_=_<_p_a_t_t_e_r_n_>: Only consider tags matching the given gglloobb((77)) pattern, excluding the
                       "refs/tags/" prefix.

                   •   _e_x_c_l_u_d_e_=_<_p_a_t_t_e_r_n_>: Do not consider tags matching the given gglloobb((77)) pattern, excluding the
                       "refs/tags/" prefix.

               _%_S
                   ref name given on the command line by which the commit was reached (like ggiitt lloogg ----ssoouurrccee), only
                   works with ggiitt lloogg
               ...
               _%_G_?
                   ...
                   expired key, "R" for a good signature made by a revoked key, "E" if the signature cannot be
               ...
               _%_g_D
                   reflog selector, e.g., rreeffss//ssttaasshh@@{{11}} or rreeffss//ssttaasshh@@{{22 mmiinnuutteess aaggoo}}; the format follows the rules
                   described for the --gg option. The portion before the @@ is the refname as given on the command line
                   (so ggiitt lloogg --gg rreeffss//hheeaaddss//mmaasstteerr would yield rreeffss//hheeaaddss//mmaasstteerr@@{{00}}).

               _%_g_d
                   shortened reflog selector; same as %%ggDD, but the refname portion is shortened for human
               ...
               _%_g_N
                   reflog identity name (respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))

               _%_g_e
                   reflog identity email

               _%_g_E
                   reflog identity email (respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))

               _%_g_s
                   reflog subject

               _%_(_t_r_a_i_l_e_r_s_[_:_o_p_t_i_o_n_s_]_)
                   display the trailers of the body as interpreted by ggiitt--iinntteerrpprreett--ttrraaiilleerrss(1). The ttrraaiilleerrss string
                   may be followed by a colon and zero or more comma-separated options. If any option is provided
                   multiple times the last occurrence wins.

                   The boolean options accept an optional value [[==<<BBOOOOLL>>]]. The values ttrruuee, ffaallssee, oonn, ooffff etc. are
                   all accepted. See the "boolean" sub-section in "EXAMPLES" in ggiitt--ccoonnffiigg(1). If a boolean option
                   is given with no value, it’s enabled.

                   •   _k_e_y_=_<_K_>: only show trailers with specified key. Matching is done case-insensitively and
                       trailing colon is optional. If option is given multiple times trailer lines matching any of
                       the keys are shown. This option automatically enables the oonnllyy option so that non-trailer
                       lines in the trailer block are hidden. If that is not desired it can be disabled with
                       oonnllyy==ffaallssee. E.g., %%((ttrraaiilleerrss::kkeeyy==RReevviieewweedd--bbyy)) shows trailer lines with key RReevviieewweedd--bbyy.

                   •   _o_n_l_y_[_=_<_B_O_O_L_>_]: select whether non-trailer lines from the trailer block should be included.

                   •   _s_e_p_a_r_a_t_o_r_=_<_S_E_P_>: specify a separator inserted between trailer lines. When this option is not
                       given each trailer line is terminated with a line feed character. The string SEP may contain
                       the literal formatting codes described above. To use comma as separator one must use %%xx22CC as
                       it would otherwise be parsed as next option. E.g., %%((ttrraaiilleerrss::kkeeyy==TTiicckkeett,,sseeppaarraattoorr==%%xx22CC ))
                       shows all trailer lines whose key is "Ticket" separated by a comma and a space.

                   •   _u_n_f_o_l_d_[_=_<_B_O_O_L_>_]: make it behave as if interpret-trailer’s ----uunnffoolldd option was given. E.g.,
                       %%((ttrraaiilleerrss::oonnllyy,,uunnffoolldd==ttrruuee)) unfolds and shows all trailer lines.
                   ...
                   •   _k_e_y___v_a_l_u_e___s_e_p_a_r_a_t_o_r_=_<_S_E_P_>: specify a separator inserted between trailer lines. When this
                       option is not given each trailer key-value pair is separated by ": ". Otherwise it shares the
           ...
           %%gg** reflog options will insert an empty string unless we are traversing reflog entries (e.g., by ggiitt lloogg
           --gg). The %%dd and %%DD placeholders will use the "short" decoration format if ----ddeeccoorraattee was not already
       ...
       If you add a ` ` (space) after _% of a placeholder, a space is inserted immediately before the expansion if
...
DDIIFFFF FFOORRMMAATTTTIINNGG
       By default, ggiitt lloogg does not generate any diff output. The options below can be used to show the changes made
       by each commit.

       Note that unless one of ----ddiiffff--mmeerrggeess variants (including short --mm, --cc, and ----cccc options) is explicitly
       given, merge commits will not show a diff, even if a diff format like ----ppaattcchh is selected, nor will they
       match search options like --SS. The exception is when ----ffiirrsstt--ppaarreenntt is in use, in which case ffiirrsstt--ppaarreenntt is
       the default format.
       ...
       --diff-merges=(off|none|on|first-parent|1|separate|m|combined|c|dense-combined|cc), --no-diff-merges
           Specify diff format to be used for merge commits. Default is ooffff unless ----ffiirrsstt--ppaarreenntt is in use, in
           which case ffiirrsstt--ppaarreenntt is the default.
           ...
           --diff-merges=on, --diff-merges=m, -m
               This option makes diff output for merge commits to be shown in the default format.  --mm will produce
               the output only if --pp is given as well. The default format could be changed using lloogg..ddiiffffMMeerrggeess
               configuration parameter, which default value is sseeppaarraattee.
           ...
           --diff-merges=separate
               This makes merge commits show the full diff with respect to each of the parents. Separate log entry
           ...
           --diff-merges=combined, --diff-merges=c, -c
               ...
               at a time. Furthermore, it lists only files which were modified from all parents.  --cc implies --pp.

           --diff-merges=dense-combined, --diff-merges=cc, --cc
               With this option the output produced by ----ddiiffff--mmeerrggeess==ccoommbbiinneedd is further compressed by omitting
               uninteresting hunks whose contents in the parents have only two variants and the merge result picks
               one of them without modification.  ----cccc implies --pp.

       --combined-all-paths
           This flag causes combined diffs (used for merge commits) to list the name of the file from all parents.
           It thus only has effect when ----ddiiffff--mmeerrggeess==[[ddeennssee--]]ccoommbbiinneedd is in use, and is likely only useful if
           filename changes are detected (i.e. when either rename or copy detection have been requested).

       -U<n>, --unified=<n>
           Generate diffs with <n> lines of context instead of the usual three. Implies ----ppaattcchh.

       --output=<file>
           Output to a specific file instead of stdout.

       --output-indicator-new=<char>, --output-indicator-old=<char>, --output-indicator-context=<char>
           Specify the character used to indicate new, old or context lines in the generated patch. Normally they
           are _+, _- and ' ' respectively.
       ...
       --diff-algorithm={patience|minimal|histogram|myers}
           ...
           For instance, if you configured the ddiiffff..aallggoorriitthhmm variable to a non-default value and want to use the
           default one, then you have to use ----ddiiffff--aallggoorriitthhmm==ddeeffaauulltt option.
       ...
       --compact-summary
           ...
           executable bit respectively) in diffstat. The information is put between the filename part and the graph
       ...
       -X[<param1,param2,...>], --dirstat[=<param1,param2,...>]
           ...
           lliinneess
               ...
               no natural concept of lines). This is a more expensive ----ddiirrssttaatt behavior than the cchhaannggeess behavior,
               but it does count rearranged lines within a file as much as other changes. The resulting output is
       ...
       --name-only
           Show only names of changed files. The file names are often encoded in UTF-8. For more information see the
           discussion about encoding in the ggiitt--lloogg(1) manual page.
       ...
       --name-status
           ...
           status letters mean. Just like ----nnaammee--oonnllyy the file names are often encoded in UTF-8.
       ...
       --color-moved[=<mode>]
           ...
           blocks
               ...
               blocks are painted using either the _c_o_l_o_r_._d_i_f_f_._{_o_l_d_,_n_e_w_}_M_o_v_e_d color. Adjacent blocks cannot be told
               apart.

           zebra
               Blocks of moved text are detected as in _b_l_o_c_k_s mode. The blocks are painted using either the
               _c_o_l_o_r_._d_i_f_f_._{_o_l_d_,_n_e_w_}_M_o_v_e_d color or _c_o_l_o_r_._d_i_f_f_._{_o_l_d_,_n_e_w_}_M_o_v_e_d_A_l_t_e_r_n_a_t_i_v_e. The change between the two
       ...
       --no-color-moved
           ...
           ----ccoolloorr--mmoovveedd==nnoo.

       --color-moved-ws=<modes>
           This configures how whitespace is ignored when performing the move detection for ----ccoolloorr--mmoovveedd. These
           ...
           allow-indentation-change
               Initially ignore any whitespace in the move detection, then group the moved code blocks only into a
               block if the change in whitespace is the same per line. This is incompatible with the other modes.

       --no-color-moved-ws
           Do not ignore whitespace when performing move detection. This can be used to override configuration
           settings. It is the same as ----ccoolloorr--mmoovveedd--wwss==nnoo.
       ...
       --check
           ...
           controlled by ccoorree..wwhhiitteessppaaccee configuration. By default, trailing whitespaces (including lines that
           consist solely of whitespaces) and a space character that is immediately followed by a tab character
       ...
       --ws-error-highlight=<kind>
           Highlight whitespace errors in the ccoonntteexxtt, oolldd or nneeww lines of the diff. Multiple values are separated
           by comma, nnoonnee resets previous values, ddeeffaauulltt reset the list to nneeww and aallll is a shorthand for
           ...
           not set, only whitespace errors in nneeww lines are highlighted. The whitespace errors are colored with
       ...
       --binary
           In addition to ----ffuullll--iinnddeexx, output a binary diff that can be applied with ggiitt--aappppllyy. Implies ----ppaattcchh.

       --abbrev[=<n>]
           Instead of showing the full 40-byte hexadecimal object name in diff-raw format output and diff-tree
           header lines, show the shortest prefix that is at least _<_n_> hexdigits long that uniquely refers the
           object. In diff-patch output format, ----ffuullll--iinnddeexx takes higher precedence, i.e. if ----ffuullll--iinnddeexx is
           specified, full blob names will be shown regardless of ----aabbbbrreevv. Non default number of digits can be
           specified with ----aabbbbrreevv==<<nn>>.
       ...
       -B[<n>][/<m>], --break-rewrites[=[<n>][/<m>]]
           ...
           single deletion of everything old followed by a single insertion of everything new, and the number mm
           controls this aspect of the -B option (defaults to 60%).  --BB//7700%% specifies that less than 30% of the
           ...
           considers a file that disappeared as the source of a rename), and the number nn controls this aspect of
           the -B option (defaults to 50%).  --BB2200%% specifies that a change with addition and deletion compared to
           20% or more of the file’s size are eligible for being picked up as a possible source of a rename to
           another file.

       -M[<n>], --find-renames[=<n>]
           If generating diffs, detect and report renames for each commit. For following files across renames while
           traversing history, see ----ffoollllooww. If nn is specified, it is a threshold on the similarity index (i.e.
           amount of addition/deletions compared to the file’s size). For example, --MM9900%% means Git should consider a
           delete/add pair to be a rename if more than 90% of the file hasn’t changed. Without a %% sign, the number
           is to be read as a fraction, with a decimal point before it. I.e., --MM55 becomes 0.5, and is thus the same
           as --MM5500%%. Similarly, --MM0055 is the same as --MM55%%. To limit detection to exact renames, use --MM110000%%. The
           default similarity index is 50%.

       -C[<n>], --find-copies[=<n>]
           Detect copies as well as renames. See also ----ffiinndd--ccooppiieess--hhaarrddeerr. If nn is specified, it has the same
           meaning as for --MM<<nn>>.

       --find-copies-harder
           For performance reasons, by default, --CC option finds copies only if the original file of the copy was
           modified in the same changeset. This flag makes the command inspect unmodified files as candidates for
           the source of copy. This is a very expensive operation for large projects, so use it with caution. Giving
           more than one --CC option has the same effect.

       -D, --irreversible-delete
           Omit the preimage for deletes, i.e. print only the header but not the diff between the preimage and
           //ddeevv//nnuullll. The resulting patch is not meant to be applied with ppaattcchh or ggiitt aappppllyy; this is solely for
           people who want to just concentrate on reviewing the text after the change. In addition, the output
           obviously lacks enough information to apply such a patch in reverse, even manually, hence the name of the
           option.

           When used together with --BB, omit also the preimage in the deletion part of a delete/create pair.

       -l<num>
           The --MM and --CC options involve some preliminary steps that can detect subsets of renames/copies cheaply,
           followed by an exhaustive fallback portion that compares all remaining unpaired destinations to all
           relevant sources. (For renames, only remaining unpaired sources are relevant; for copies, all original
           sources are relevant.) For N sources and destinations, this exhaustive check is O(N^2). This option
           prevents the exhaustive portion of rename/copy detection from running if the number of source/destination
           files involved exceeds the specified number. Defaults to diff.renameLimit. Note that a value of 0 is
           treated as unlimited.

       --diff-filter=[(A|C|D|M|R|T|U|X|B)...[*]]
           Select only files that are Added (AA), Copied (CC), Deleted (DD), Modified (MM), Renamed (RR), have their type
           (i.e. regular file, symlink, submodule, ...) changed (TT), are Unmerged (UU), are Unknown (XX), or have had
           their pairing Broken (BB). Any combination of the filter characters (including none) can be used. When **
           ...
           Also, these upper-case letters can be downcased to exclude. E.g.  ----ddiiffff--ffiilltteerr==aadd excludes added and
           deleted paths.
       ...
       -S<string>
           ...
           It is useful when you’re looking for an exact block of code (like a struct), and want to know the history
           of that block since it first came into being: use the feature iteratively to feed the interesting block
           in the preimage back into --SS, and keep going until you get the very first version of the block.
       ...
       -G<regex>
           ...
           To illustrate the difference between --SS<<rreeggeexx>> ----ppiicckkaaxxee--rreeggeexx and --GG<<rreeggeexx>>, consider a commit with the
           ...
           While ggiitt lloogg --GG""ffrroottzz\\((nniittffooll"" will show this commit, ggiitt lloogg --SS""ffrroottzz\\((nniittffooll"" ----ppiicckkaaxxee--rreeggeexx will not
           (because the number of occurrences of that string did not change).

           Unless ----tteexxtt is supplied patches of binary files without a textconv filter will be ignored.

           See the _p_i_c_k_a_x_e entry in ggiittddiiffffccoorree(7) for more information.

       --find-object=<object-id>
           Look for differences that change the number of occurrences of the specified object. Similar to --SS, just
           the argument is different in that it doesn’t search for a specific string but for a specific object id.

           The object can be a blob or a submodule commit. It implies the --tt option in ggiitt--lloogg to also find trees.

       --pickaxe-all
           When --SS or --GG finds a change, show all the changes in that changeset, not just the files that contain the
           change in <string>.

       --pickaxe-regex
           Treat the <string> given to --SS as an extended POSIX regular expression to match.

       -O<orderfile>
           Control the order in which files appear in the output. This overrides the ddiiffff..oorrddeerrFFiillee configuration
           variable (see ggiitt--ccoonnffiigg(1)). To cancel ddiiffff..oorrddeerrFFiillee, use --OO//ddeevv//nnuullll.
           ...
           matches the pattern. For example, the pattern "ffoooo**bbaarr" matches "ffooooaassddffbbaarr" and "ffoooo//bbaarr//bbaazz//aassddff" but
           not "ffoooobbaarrxx".

       --skip-to=<file>, --rotate-to=<file>
           Discard the files before the named <file> from the output (i.e.  _s_k_i_p _t_o), or move them to the end of the
           output (i.e.  _r_o_t_a_t_e _t_o). These were invented primarily for use of the ggiitt ddiiffffttooooll command, and may not
       ...
       --relative[=<path>], --no-relative
           ...
           argument.  ----nnoo--rreellaattiivvee can be used to countermand both ddiiffff..rreellaattiivvee config option and previous
       ...
       --inter-hunk-context=<lines>
           ...
           close to each other. Defaults to ddiiffff..iinntteerrHHuunnkkCCoonntteexxtt or 0 if the config option is unset.

       -W, --function-context
           Show whole function as context lines for each change. The function names are determined in the same way
           as ggiitt ddiiffff works out patch hunk headers (see _D_e_f_i_n_i_n_g _a _c_u_s_t_o_m _h_u_n_k_-_h_e_a_d_e_r in ggiittaattttrriibbuutteess(5)).

       --ext-diff
           Allow an external diff helper to be executed. If you set an external diff driver with ggiittaattttrriibbuutteess(5),
           you need to use this option with ggiitt--lloogg(1) and friends.
       ...
       --textconv, --no-textconv
           ...
           ggiittaattttrriibbuutteess(5) for details. Because textconv filters are typically a one-way conversion, the resulting
           diff is suitable for human consumption, but cannot be applied. For this reason, textconv filters are
           enabled by default only for ggiitt--ddiiffff(1) and ggiitt--lloogg(1), but not for ggiitt--ffoorrmmaatt--ppaattcchh(1) or diff plumbing
           commands.
       ...
       --ignore-submodules[=<when>]
           ...
           used to override any settings of the _i_g_n_o_r_e option in ggiitt--ccoonnffiigg(1) or ggiittmmoodduulleess(5). When "untracked" is
       ...
       --ita-invisible-in-index
           By default entries added by "git add -N" appear as an existing empty file in "git diff" and a new file in
           "git diff --cached". This option makes the entry appear as a new file in "git diff" and non-existent in
           "git diff --cached". This option could be reverted with ----iittaa--vviissiibbllee--iinn--iinnddeexx. Both options are
...
GGEENNEERRAATTIINNGG PPAATTCCHH TTEEXXTT WWIITTHH --PP
       Running ggiitt--ddiiffff(1), ggiitt--lloogg(1), ggiitt--sshhooww(1), ggiitt--ddiiffff--iinnddeexx(1), ggiitt--ddiiffff--ttrreeee(1), or ggiitt--ddiiffff--ffiilleess(1) with
       the --pp option produces patch text. You can customize the creation of patch text via the GGIITT__EEXXTTEERRNNAALL__DDIIFFFF and
       the GGIITT__DDIIFFFF__OOPPTTSS environment variables (see ggiitt(1)), and the ddiiffff attribute (see ggiittaattttrriibbuutteess(5)).
       ...
       What the -p option produces is slightly different from the traditional diff format:
        ...
        1. It is preceded with a "git diff" header that looks like this:
           ...
           The aa// and bb// filenames are the same unless rename/copy is involved. Especially, even for a creation or a
           deletion, //ddeevv//nnuullll is _n_o_t used in place of the aa// or bb// filenames.

           When rename/copy is involved, ffiillee11 and ffiillee22 show the name of the source file of the rename/copy and the
        ...
        2. It is followed by one or more extended header lines:
           ...
           The index line includes the blob object names before and after the change. The <mode> is included if the
           file mode does not change; otherwise, separate lines indicate the old and the new mode.

        3. Pathnames with "unusual" characters are quoted as explained for the configuration variable ccoorree..qquuootteePPaatthh
           (see ggiitt--ccoonnffiigg(1)).

        4. All the ffiillee11 files in the output refer to files before the commit, and all the ffiillee22 files refer to
           files after the commit. It is incorrect to apply each change to each file sequentially. For example, this
        ...
        5. Hunk headers mention the name of the function to which the hunk applies. See "Defining a custom
           hunk-header" in ggiittaattttrriibbuutteess(5) for details of how to tailor to this to specific languages.

CCOOMMBBIINNEEDD DDIIFFFF FFOORRMMAATT
       Any diff-generating command can take the --cc or ----cccc option to produce a _c_o_m_b_i_n_e_d _d_i_f_f when showing a merge.
       This is the default format when showing merges with ggiitt--ddiiffff(1) or ggiitt--sshhooww(1). Note also that you can give
       suitable ----ddiiffff--mmeerrggeess option to any of these commands to force generation of diffs in specific format.
       ...
       A "combined diff" format looks like this:
        ...
        1. It is preceded with a "git diff" header, that looks like this (when the --cc option is used):
        ...
        2. It is followed by one or more extended header lines (this example shows a merge with two parents):
           ...
           The mmooddee <<mmooddee>>,,<<mmooddee>>....<<mmooddee>> line appears only if at least one of the <mode> is different from the
           rest. Extended headers with information about detected contents movement (renames and copying detection)
           are designed to work with diff of two <tree-ish> and are not used by combined diff format.
        ...
        3. It is followed by two-line from-file/to-file header
           ...
           Similar to two-line header for traditional _u_n_i_f_i_e_d diff format, //ddeevv//nnuullll is used to signal created or
           deleted files.

           However, if the --combined-all-paths option is provided, instead of a two-line from-file/to-file you get
           a N+1 line from-file/to-file header, where N is the number of parents in the merge commit
        ...
        4. Chunk header format is modified to prevent people from accidentally feeding it to ppaattcchh --pp11. Combined
           diff format was created for review of merge commit changes, and was not meant to be applied. The change
           is similar to the change in the extended _i_n_d_e_x header:

               @@@ <from-file-range> <from-file-range> <to-file-range> @@@

           There are (number of parents + 1) @@ characters in the chunk header for combined diff format.

       Unlike the traditional _u_n_i_f_i_e_d diff format, which shows two files A and B with a single column that has --
       ...
       both file1 and file2, plus ++++ to mean one line that was added does not appear in either file1 or file2). Also
       eight other lines are the same from file1 but do not appear in file2 (hence prefixed with ++).

       When shown by ggiitt ddiiffff--ttrreeee --cc, it compares the parents of a merge commit with the merge result (i.e.
       file1..fileN are the parents). When shown by ggiitt ddiiffff--ffiilleess --cc, it compares the two unresolved merge parents
...
EEXXAAMMPPLLEESS
       ...
       ggiitt lloogg vv22..66..1122.... iinncclluuddee//ssccssii ddrriivveerrss//ssccssii
           Show all commits since version _v_2_._6_._1_2 that changed any file in the iinncclluuddee//ssccssii or ddrriivveerrss//ssccssii
           subdirectories

       ggiitt lloogg ----ssiinnccee==""22 wweeeekkss aaggoo"" ---- ggiittkk
           Show the changes during the last two weeks to the file _g_i_t_k. The ---- is necessary to avoid confusion with
           the bbrraanncchh named _g_i_t_k
       ...
       ggiitt lloogg ----ffoollllooww bbuuiillttiinn//rreevv--lliisstt..cc
           Shows the commits that changed bbuuiillttiinn//rreevv--lliisstt..cc, including those commits that occurred before the file
       ...
       ggiitt lloogg ----bbrraanncchheess ----nnoott ----rreemmootteess==oorriiggiinn
           Shows all commits that are in any of local branches but not in any of remote-tracking branches for _o_r_i_g_i_n
...
DDIISSCCUUSSSSIIOONN
       ...
       •   Commit log messages are typically encoded in UTF-8, but other extended ASCII encodings are also
           supported. This includes ISO-8859-x, CP125x and many others, but _n_o_t UTF-16/32, EBCDIC and CJK multi-byte
       ...
       to use legacy encodings, Git does not forbid it. However, there are a few things to keep in mind.
        ...
        1. _g_i_t _c_o_m_m_i_t and _g_i_t _c_o_m_m_i_t_-_t_r_e_e issues a warning if the commit log message given to it does not look like
           a valid UTF-8 string, unless you explicitly say your project uses a legacy encoding. The way to say this
           is to have ii1188nn..ccoommmmiittEEnnccooddiinngg in ..ggiitt//ccoonnffiigg file, like this:

               [i18n]
                       commitEncoding = ISO-8859-1

           Commit objects created with the above setting record the value of ii1188nn..ccoommmmiittEEnnccooddiinngg in its eennccooddiinngg
        ...
        2. _g_i_t _l_o_g, _g_i_t _s_h_o_w, _g_i_t _b_l_a_m_e and friends look at the eennccooddiinngg header of a commit object, and try to
...
CCOONNFFIIGGUURRAATTIIOONN
       See ggiitt--ccoonnffiigg(1) for core variables and ggiitt--ddiiffff(1) for settings related to diff generation.

       format.pretty
           Default for the ----ffoorrmmaatt option. (See _P_r_e_t_t_y _F_o_r_m_a_t_s above.) Defaults to mmeeddiiuumm.

       i18n.logOutputEncoding
           Encoding to use when displaying logs. (See _D_i_s_c_u_s_s_i_o_n above.) Defaults to the value of
           ii1188nn..ccoommmmiittEEnnccooddiinngg if set, and UTF-8 otherwise.

       log.date
           Default format for human-readable dates. (Compare the ----ddaattee option.) Defaults to "default", which means
           to write dates like SSaatt MMaayy 88 1199::3355::3344 22001100 --00550000.

           If the format is set to "auto:foo" and the pager is in use, format "foo" will be the used for the date
       ...
       log.showRoot
           If ffaallssee, ggiitt lloogg and related commands will not treat the initial commit as a big creation event. Any
           root commits in ggiitt lloogg --pp output would be shown without a diff attached. The default is ttrruuee.

       log.showSignature
           If ttrruuee, ggiitt lloogg and related commands will act as if the ----sshhooww--ssiiggnnaattuurree option was passed to them.

       mailmap.*
           See ggiitt--sshhoorrttlloogg(1).

       notes.displayRef
           Which refs, in addition to the default set by ccoorree..nnootteessRReeff or GGIITT__NNOOTTEESS__RREEFF, to read notes from when
           showing commit messages with the lloogg family of commands. See ggiitt--nnootteess(1).

           May be an unabbreviated ref name or a glob and may be specified multiple times. A warning will be issued
           for refs that do not exist, but a glob that does not match any refs is silently ignored.

           This setting can be disabled by the ----nnoo--nnootteess option, overridden by the GGIITT__NNOOTTEESS__DDIISSPPLLAAYY__RREEFF
           environment variable, and overridden by the ----nnootteess==<<rreeff>> option.

GGIITT
       Part of the ggiitt(1) suite

Git 2.34.1                                           02/08/2023                                           GIT-LOG(1)
